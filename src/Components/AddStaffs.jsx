...
const AddStaffs = () => {
    ...
    const addStaffs = async () => {
        const response = await fetch("https://localhost:7256/api/authenticate/addStaff", {
            method: "POST",
        ...
        //     setError(newError)
        //     toast.error("Staff with this username already exists!")
        // }
                ...
                <form onSubmit={submitCourse} className="flex flex-col mt-20 gap-y-6">
                    <div className="flex flex-row gap-x-5">
                        <div className="bg-purple-200 w-fit">
                            <div style={{ marginTop: "-22px" }} className="basisblack flex flex-row text-gray-900 text-2xl tracking-tighter ">Add a Staff</div>
                        </div>

    ...
    return (
        <>
            ...
            <div className="w-full flex flex-col gap-y-10">
                ...
                <div className="w-full flex flex-col items-center py-8 gap-y-2 mb-10">
                ...
                <div className="w-full flex flex-col items-start px-28 gap-y-7">
                    <div className=" flex flex-row gap-x-2 h-7 w-full">
                        <div className="flex flex-row justify-between w-full">
                            ...
                            <div className="items-end basisregular hover:underline cursor-pointer">View All</div>
                        </div>
                ...
                <div className="flex flex-col mt-28 w-full items-center gap-y-20">
                    <div className="bg-purple-100 basisregular font-bold text-5xl w-fit flex ">
